...
(function () {
    ...
    tinymce.PluginManager.requireLangPack('emotions2');

    tinymce.create('tinymce.plugins.Emotions2Plugin', {
        /**
        ...
        */
        init: function (ed, url) {
            ...
            ed.addCommand('mceEmotions2', function () {
            ...
            ed.addButton('emotions2', {
                title: '使用表情符號',
                cmd: 'mceEmotions2',
                image: url + '/img/emotions2_icon.png'
    ...
    // Register plugin
    tinymce.PluginManager.add('emotions2', tinymce.plugins.Emotions2Plugin);
})();