...
var YoutubeDialog = {
    ...
    insert: function () {
		...
		tinyMCEPopup.editor.execCommand('mceInsertContent', false, '<iframe width="489" height="360" src="http://www.youtube.com/embed/' + code + '" frameborder="0" allowfullscreen></iframe>');
